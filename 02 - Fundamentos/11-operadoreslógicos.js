...
//&& - MD (É lógico):Retorna true se ambos os operandos forem verdadeiros.
...
if (a > 0 || b > 0) {
  ...
  console.log("Nenhum dos valores é zero");
}

//Exemplo do operando NÃO lógico(!)
let souDesenvolvedor = true;

if (!souDesenvolvedor) {
  console.log("Eu não sou desenvolvedor.");
} else {
